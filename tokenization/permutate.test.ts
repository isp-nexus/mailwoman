...
test("permutate: simple", (t) => {
	...
	const actual = permutate(spans, 1, 6)
	t.deepEquals(actual, [perm1, perm2, perm3, perm4, perm5, perm6, perm7, perm8, perm9, perm10])
	t.end()
})

test("permutate: tokens contain whitespace", (t) => {
	const spans = Span.connectSiblings(new Span("SoHo", 0), new Span("New York", 5), new Span("USA", 14))
...
test("permutate: start/end values", (t) => {
	...
	const perm2 = new Span("SoHo New", 2)
	...
	const perm4 = new Span("New York", 11)
...
test("permutate: relationships", (t) => {
	const span1 = new Span("SoHo", 0)
	const span2 = new Span("New", 5)
	const span3 = new Span("York", 14)
	const spans = Span.connectSiblings(span1, span2, span3)

	const actual = permutate(spans, 1, 6)

	// Soho New York
	const perm1 = actual[0]!
...
test("permutate: with hyphen", (t) => {
	...
	const perm13 = new Span("York USA", 9)
	...
	const actual = permutate(spans, 1, 10)
	t.deepEquals(actual, [
		perm1,
		perm2,
		perm3,
