...
// export interface FSTSubGraphNode {
// 	">count": number
// 	"<count": number
// }

// export type FSTNode = Graph<FSTSubGraphNode>

// export type FSTDirection = "<" | ">"

// export type FSTCallback = (child: Graph, parent: Graph, char: string) => void

// /**
//  * Finite State Transducer
//  *
//  * This class is used to index tokens for fast lookup.
//  */
// export class FST {
// 	public head: FSTNode = new Graph()
// 	public tail: FSTNode = new Graph()
...
// 	_walk(parent: Graph<Graph>, direction: FSTDirection, chars: string, create: boolean, each: FSTCallback) {
// 		const DIR = direction === "<" ? "<" : ">"
...
// 				if (!child) {
// 					child = new Graph<FSTSubGraphNode>()
...
// 	/**
// 	 * Dump FST to stderr, eg: [3] >e>x [3] >e>x>a [2] >e>x>a>m [2] >e>x>a>m>p [2] >e>x>a>m>p>l [2]>
// 	 * E>x>a>m>p>l>e [2] >e>x>a>m>p>l>e>s [3] >e>x>c [1] >e>x>c>e [1] >e>x>c>e>s [1] >e>x>c>e>s>s
// 	 */
// 	print(node: FSTNode, direction: FSTDirection) {
// 		this._recurse(node, direction, (path, count) => {
// 			console.error(`[${count}] ${path}`)
// 		})
// 	}

// 	_recurse(node: FSTNode, direction: FSTDirection, each: FSTCallback, prefix = "") {
// 		if (!direction) {
// 			direction = ">"
// 		}
