...
module.exports.tests.classify = (test) => {
	test("classify", (t) => {
		...
		const classification = new (class Mock {})()
	...
	test("classify - duplicate with lower confidence", (t) => {
		...
		const classification1 = new (class Mock {})()
		const classification2 = new (class Mock {})()
...
module.exports.tests.connectSiblings = (test) => {
	test("connectSiblings - array list", (t) => {
		const spans = [new Span("A"), new Span("B"), new Span("C")]
