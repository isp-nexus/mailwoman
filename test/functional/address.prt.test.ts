...
assert("Rua Luis de Camoes", [{ street: "Rua Luis de Camoes" }])
...
assert("Tv. da Horta 27A", [{ street: "Tv. da Horta" }, { housenumber: "27A" }])
...
assert("rua godinho de faria 1200", [{ street: "rua godinho de faria" }, { housenumber: "1200" }])
