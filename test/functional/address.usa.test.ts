...
assert("Martin Luther King Jr. Blvd.", [{ street: "Martin Luther King Jr. Blvd." }])

assert("Martin Luther King Blvd.", [{ street: "Martin Luther King Blvd." }])

assert("E Cesar Chavez St", [{ street: "E Cesar Chavez St" }])

assert("Riverbend Club Dr Se", [{ street: "Riverbend Club Dr Se" }])

assert("S Interstate 35", [{ street: "S Interstate 35" }])

assert("E William Cannon Dr", [{ street: "E William Cannon Dr" }])

assert("Branch Rd", [{ street: "Branch Rd" }])

assert("Manor Rd", [{ street: "Manor Rd" }])

assert("Fm 3009 TX", [{ street: "Fm 3009" }, { region: "TX" }])

assert("1900 SE A ST, SAN FRANCISCO", [{ housenumber: "1900" }, { street: "SE A ST" }, { locality: "SAN FRANCISCO" }])

assert("1900 SE F ST, SAN FRANCISCO", [{ housenumber: "1900" }, { street: "SE F ST" }, { locality: "SAN FRANCISCO" }])

assert("22024 main st, ca", [{ housenumber: "22024" }, { street: "main st" }, { region: "ca" }])
...
assert(
	...
	[{ housenumber: "1111" }, { street: "MD 760" }, { locality: "Lusby" }, { region: "MD" }, { country: "USA" }],
	true
)
...
assert("#6 Montague Terrace Brooklyn NY", [{ street: "Montague Terrace" }, { locality: "Brooklyn" }, { region: "NY" }])
...
assert("Broadway, Manhattan", [{ street: "Broadway" }, { locality: "Manhattan" }])
assert("24 Broadway, Manhattan", [{ housenumber: "24" }, { street: "Broadway" }, { locality: "Manhattan" }])
assert("Broadway 24, Manhattan", [{ street: "Broadway" }, { housenumber: "24" }, { locality: "Manhattan" }])
assert("East Broadway, Manhattan", [{ street: "East Broadway" }, { locality: "Manhattan" }])
assert("24 East Broadway, Manhattan", [{ housenumber: "24" }, { street: "East Broadway" }, { locality: "Manhattan" }])
assert("West Broadway, Manhattan", [{ street: "West Broadway" }, { locality: "Manhattan" }])
assert("24 West Broadway, Manhattan", [{ housenumber: "24" }, { street: "West Broadway" }, { locality: "Manhattan" }])
