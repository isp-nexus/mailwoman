...
assert("Esplanade, Berlin", [{ street: "Esplanade" }, { locality: "Berlin" }])

assert("Esplanade 17, Berlin", [{ street: "Esplanade" }, { housenumber: "17" }, { locality: "Berlin" }])

assert("17 Esplanade, Berlin", [{ housenumber: "17" }, { street: "Esplanade" }, { locality: "Berlin" }])

assert("Königsallee Düsseldorf", [{ street: "Königsallee" }, { locality: "Düsseldorf" }])
...
assert("Eberswalder Straße 100 104", [{ street: "Eberswalder Straße" }, { housenumber: "100" }])

// addresses on numbered streets in europe
assert("25 Straße 50", [{ street: "25 Straße" }, { housenumber: "50" }])
assert("25 Straße, 50", [{ street: "25 Straße" }, { housenumber: "50" }])
assert("25 Strada 50", [{ street: "25 Strada" }, { housenumber: "50" }])
assert("25 Strada, 50", [{ street: "25 Strada" }, { housenumber: "50" }])
