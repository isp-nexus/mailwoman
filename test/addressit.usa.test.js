...
const testcase = (test, common) => {
	...
	assert("New York, New York", [{ locality: "New York" }, { region: "New York" }])
	...
	assert("Grand canyon 86023", [{ locality: "Grand canyon" }, { postcode: "86023" }])

	assert("CT, 06410", [{ region: "CT" }, { postcode: "06410" }])

	assert("BOOM", [{ locality: "BOOM" }])

	assert("Niagara Falls 76B09", [{ locality: "Niagara Falls" }])
