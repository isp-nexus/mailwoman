...
const testcase = (test, common) => {
	...
	assert("Sydney 2000", [{ locality: "Sydney" }, { postcode: "2000" }])
	...
	assert("Eight Mile Plains 4113", [{ locality: "Eight Mile Plains" }, { postcode: "4113" }])
	...
	assert("Eight Mile Plains 9999", [{ locality: "Eight Mile Plains" }, { postcode: "9999" }])
}
